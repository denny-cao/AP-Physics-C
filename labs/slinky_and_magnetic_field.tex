    ...
    \section{Data}
     ...
     \begin{enumerate}[1.]
         ...
         \begin{figure}[H]
            ...
            \begin{tikzpicture}
               \begin{axis}[
                  xlabel=Turns/\si{\meter} (\si{\meter^{-1}}),
                  ylabel=Magnetic Field (\si{\milli\tesla}),
                  xmin=0,
                  xmax=200,
                  ymin=0,
                  ...
                  % Plot data
                  \addplot[only marks,mark=*,color=blue] coordinates {(166,0.2699) (83,0.2101) (55.3,0.1484) (41.5,0.1190)};

                  % Plot best fit line y=mx+b
                  \addplot[domain=0:200,smooth,red] {0.00115465*x+0.0870302};
                  \addlegendentry{Experimental}
                  \addlegendentry{Best Fit Line}
               \end{axis}
            \end{tikzpicture}
